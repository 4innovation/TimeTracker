...
namespace DataGridViewRichTextBox
{
    public class DataGridViewRichTextBoxColumn : DataGridViewColumn
    {
        ...
        public DataGridViewRichTextBoxColumn()
            : base(new DataGridViewRichTextBoxCell(new DataGridView()))
        { 
        }

        public DataGridViewRichTextBoxColumn(DataGridView dataGridView)
            : base(new DataGridViewRichTextBoxCell(dataGridView))
        {
    ...
    public class DataGridViewRichTextBoxCell : DataGridViewImageCell
    {
        ...
        public DataGridViewRichTextBoxCell(DataGridView dataGridView)
        {
            _dataGridView = dataGridView;
        }
        ...
        private Image GetRtfImage(int rowIndex, object value, bool selected)
        {
            ...
            if (ctl != null)
            {
                ...
                if (selected)
                {
                    ...
                    // Print image
                    rtfImg = RichTextBoxPrinter.Print(ctl, imgSize.Width, imgSize.Height, _dataGridView, rowIndex, true);
                ...
                {
                    rtfImg = RichTextBoxPrinter.Print(ctl, imgSize.Width, imgSize.Height, _dataGridView, rowIndex, false);
                }
